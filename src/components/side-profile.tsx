    ...
    <>
      <div className=" w-[300px] h-[300px] max-sm:w-[100%] max-sm:h-[200px] mt-0 rounded-lg overflow-hidden m-auto dark:bg-ar_color3 bg-ar_color4">
        <img
          src={ProfileImage}
          alt="Profile-photo"
          className="object-contain max-sm:w-[270px] max-sm:m-auto max-sm:-mt-7"
        />
      </div>
      <div className="mt-5 ">
        <p className="text-center mt-10 max-sm:mt-2 font-semibold text-3xl max-sm:font-bold">
      ...
      <div className="mt-10 max-sm:my-8 flex flex-row justify-between gap-2 w-[50%] m-auto mb-2">
        <a
