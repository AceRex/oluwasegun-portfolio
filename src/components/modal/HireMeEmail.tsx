  ...
  return (
    <div className="absolute max-md:fixed top-0 left-0 dark:bg-ar_color1/20 bg-ar_color1/40 backdrop-blur-lg z-0 h-screen w-screen max-sm:min-h-screen p-12 max-sm:p-2">
      <form className="dark:bg-ar_color1 bg-ar_neutral_alpha w-[50%] max-sm:w-[100%] m-auto p-24 max-sm:p-5 max-sm:py-10 text-center rounded-xl">
        <div className="mb-6">
          <p className="font-extrabold text-4xl max-sm:text-3xl text-ar_color4 dark:text-ar_color4">Hire Me!</p>
        ...
        <div className="flex flex-col text-left gap-2 mb-4">
          <label className="font-semibold ml-1  dark:text-ar_neutral text-ar_color1">Name</label>
          <input
            value={hireMeName}
            type="text"
            name="user_name"
        ...
        <div className="flex flex-col text-left gap-2 mb-4">
          <label className="font-semibold ml-1 dark:text-ar_neutral text-ar_color1">Email</label>
          <input
            value={email}
            type="email"
            name="user_email"
        ...
        <div className="flex flex-col text-left gap-2 mb-4">
          <label className="font-semibold ml-1 dark:text-ar_neutral text-ar_color1">Message</label>
          <textarea
            value={message}
            name="message"
